...
The python version of the example below was written by our TA Peng Xu and can be found here: <a href="data/week2/W2_MLR_Python.html"> <b>Python Version</b> </a> <br>

You can also download the birthweight and seatpos here: <a href="data/week2/Birthweight.csv" download> Birthweight.csv </a> and <a href="data/week2/seatpos.csv" download>seatpos.csv</a> 
...
for(i in 1:p){
  var_id = c(1:i, (p+1))
  var_id = var_id[var_id != 2] # remove the response variable
  myfit = lm( birthweight[train.id, 2]~., birthweight[ train.id, var_id ] )
